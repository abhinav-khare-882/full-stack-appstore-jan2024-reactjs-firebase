...
import { Two, Three, Four, Five, Seven } from "../assets";
      ...
      <div className="absolute inset-0 flex items-end justify-end z-50">
        <div className="w-full h-auto px-8 py-4 backdrop-blur-md bg-gradient-to-b from-transparent to-[rgba(0,0,0,0.9)]  relative  flex items-center justify-start gap-6 flex-wrap">
          ...
          <div className="flex items-center justify-center gap-2 group">
            ...
            <p className="text-textSecondary text-sm group-hover:text-secondary">Lucky Numbers</p>
          </div>
          ...
          <div className="flex items-center justify-center gap-2 group">
            ...
            <p className="text-secondary text-sm group-hover:text-secondary">Soccer</p>
          </div>
          ...
          <div className="flex items-center justify-center gap-2 group">
            ...
            <p className="text-textSecondary text-sm group-hover:text-secondary">Jacpot</p>
          </div>
          ...
          <div className="flex items-center justify-center gap-2 group">
            ...
            <p className="text-textSecondary text-sm group-hover:text-secondary">Bet Games</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="w-full h-full">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[rgba(0,0,0,0.6)] to-transparent">
        <div className="w-full h-full flex flex-col items-start justify-start px-4 py-2 lg:px-8 lg:py-6  ">
          ...
          >
            We give money for the <span className="block">first registration!</span>
          </h1>
          <p className="mt-2 text-white">
            <span className="text-secondary">Free $100!</span> Register and enter a special code
          </p>
